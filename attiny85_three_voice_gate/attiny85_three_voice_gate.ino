/*
  ATTiny85 Three-Voice Gate
  -------------------------
  Three nested gate/envelope loops carve stuttering drones on PB3/PB4.
*/
...
int main()
{
        ...
        while (1)
        {
                ...
                if (onestate ^ twostate ^ threestate)
                        PORTB |= (1 << 3) | (1 << 4);
                else
                        PORTB &= ~((1 << 3) | (1 << 4));
                ...
                if ((PINB & 1) == 0)
                {
                        ...
                        onelengthperiod = Random();
                        twolengthperiod = Random();
                        threelengthperiod = Random();
                }
