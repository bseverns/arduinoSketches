//final version eliminate serial

//array index variablity :::-->
//int myArray[] = {1, 2, 3, 4, 5};
//const int ARRAY_SIZE = sizeof(myArray) / sizeof(int);

// This uses a muy beta demo of Ogg Vorbis recording. It works...
...
void loop() {
  //if not recording and the button state has changed since the last time we looked
