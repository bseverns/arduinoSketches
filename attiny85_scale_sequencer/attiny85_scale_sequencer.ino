/*
  ATTiny85 Scale Sequencer
  ------------------------
  Tiny ROMpler of inverted ratios with buttons to shift root frequency and randomise the score.
*/
...
//float scale[] = {1, 1,  1/(9/8),  1/(6/5), 1/(4/3), 1/(3/2), 1/(8/5), 1/(9/5), 1/(2/1) }; // inverted ratios
